...
namespace Org.OpenAPITools.Model
{
    ...
    /// WorkBase
    /// </summary>
    [DataContract(Name = "WorkBase")]
    public partial class WorkBase : IEquatable<WorkBase>, IValidatableObject
    {
        /// <summary>
        ...
        public WorkBase(int id = default(int), string title = default(string), WorkBaseMainPicture mainPicture = default(WorkBaseMainPicture))
        {
            this.Id = id;
            this.Title = title;
