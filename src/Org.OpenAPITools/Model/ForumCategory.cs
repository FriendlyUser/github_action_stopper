...
namespace Org.OpenAPITools.Model
{
    ...
    /// ForumCategory
    /// </summary>
    [DataContract(Name = "ForumCategory")]
    public partial class ForumCategory : IEquatable<ForumCategory>, IValidatableObject
    {
        /// <summary>
        ...
        public ForumCategory(string title = default(string), List<ForumBoard> boards = default(List<ForumBoard>))
        {
            this.Title = title;
            this.Boards = boards;
        }
