...
namespace Org.OpenAPITools.Model
{
    ...
    /// ForumBoard
    /// </summary>
    [DataContract(Name = "ForumBoard")]
    public partial class ForumBoard : IEquatable<ForumBoard>, IValidatableObject
    {
        /// <summary>
        ...
        public ForumBoard(int id = default(int), string title = default(string), string description = default(string), List<ForumSubboard> subboards = default(List<ForumSubboard>))
        {
            this.Id = id;
            this.Title = title;
